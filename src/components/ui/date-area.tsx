  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          className={cn(
            "h-11 w-full rounded-seller-control border border-seller-border bg-white px-3 pr-10 text-seller-body outline-none focus:border-seller-primary focus:ring-2 focus:ring-seller-primary/10",
            className,
          )}
          id={inputId}
          type="date"
